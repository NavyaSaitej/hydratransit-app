...
const METRO_STATIONS = {
  ...
  Miyapur: { lat: 17.4964, lng: 78.3731, line: 'red', idx: 0 },
  JNTU: { lat: 17.4987, lng: 78.3888, line: 'red', idx: 1 },
  'KPHB Colony': { lat: 17.4938, lng: 78.4018, line: 'red', idx: 2 },
  Kukatpally: { lat: 17.4851, lng: 78.4094, line: 'red', idx: 3 },
  Balanagar: { lat: 17.477, lng: 78.415, line: 'red', idx: 4 },
  Moosapet: { lat: 17.474, lng: 78.4204, line: 'red', idx: 5 },
  'Bharat Nagar': { lat: 17.4699, lng: 78.4267, line: 'red', idx: 6 },
  Erragadda: { lat: 17.4614, lng: 78.4332, line: 'red', idx: 7 },
  'ESI Hospital': { lat: 17.4552, lng: 78.4378, line: 'red', idx: 8 },
  'SR Nagar': { lat: 17.449, lng: 78.442, line: 'red', idx: 9 },
  Ameerpet: { lat: 17.4375, lng: 78.4482, line: 'red', idx: 10 },
  Punjagutta: { lat: 17.4283, lng: 78.45, line: 'red', idx: 11 },
  'Irrum Manzil': { lat: 17.4218, lng: 78.457, line: 'red', idx: 12 },
  Khairatabad: { lat: 17.4148, lng: 78.459, line: 'red', idx: 13 },
  Lakdikapul: { lat: 17.4068, lng: 78.467, line: 'red', idx: 14 },
  Assembly: { lat: 17.403, lng: 78.472, line: 'red', idx: 15 },
  Nampally: { lat: 17.395, lng: 78.473, line: 'red', idx: 16 },
  'Gandhi Bhavan': { lat: 17.389, lng: 78.476, line: 'red', idx: 17 },
  'Osmania Medical College': { lat: 17.385, lng: 78.479, line: 'red', idx: 18 },
  'MG Bus Station': { lat: 17.3782, lng: 78.4812, line: 'red', idx: 19 },
  Malakpet: { lat: 17.375, lng: 78.492, line: 'red', idx: 20 },
  'New Market': { lat: 17.372, lng: 78.501, line: 'red', idx: 21 },
  Musarambagh: { lat: 17.369, lng: 78.508, line: 'red', idx: 22 },
  Dilsukhnagar: { lat: 17.369, lng: 78.521, line: 'red', idx: 23 },
  Chaitanyapuri: { lat: 17.367, lng: 78.531, line: 'red', idx: 24 },
  'Victoria Memorial': { lat: 17.358, lng: 78.54, line: 'red', idx: 25 },
  'LB Nagar': { lat: 17.3487, lng: 78.5482, line: 'red', idx: 26 },
  // BLUE LINE: Nagole → Raidurg (23)
  Nagole: { lat: 17.3927, lng: 78.5572, line: 'blue', idx: 0 },
  Uppal: { lat: 17.399, lng: 78.549, line: 'blue', idx: 1 },
  Stadium: { lat: 17.406, lng: 78.538, line: 'blue', idx: 2 },
  NGRI: { lat: 17.412, lng: 78.531, line: 'blue', idx: 3 },
  Habsiguda: { lat: 17.418, lng: 78.524, line: 'blue', idx: 4 },
  Tarnaka: { lat: 17.427, lng: 78.517, line: 'blue', idx: 5 },
  Mettuguda: { lat: 17.432, lng: 78.51, line: 'blue', idx: 6 },
  'Secunderabad East': { lat: 17.434, lng: 78.501, line: 'blue', idx: 7 },
  'Parade Ground': { lat: 17.4398, lng: 78.4935, line: 'blue', idx: 8 },
  Paradise: { lat: 17.444, lng: 78.486, line: 'blue', idx: 9 },
  Rasoolpura: { lat: 17.446, lng: 78.478, line: 'blue', idx: 10 },
  'Prakash Nagar': { lat: 17.444, lng: 78.47, line: 'blue', idx: 11 },
  Begumpet: { lat: 17.441, lng: 78.46, line: 'blue', idx: 12 },
  'Ameerpet B': { lat: 17.4375, lng: 78.4482, line: 'blue', idx: 13 },
  'Madhura Nagar': { lat: 17.44, lng: 78.438, line: 'blue', idx: 14 },
  Yousufguda: { lat: 17.442, lng: 78.428, line: 'blue', idx: 15 },
  ...
  'Peddamma Temple': { lat: 17.438, lng: 78.397, line: 'blue', idx: 18 },
  Madhapur: { lat: 17.445, lng: 78.39, line: 'blue', idx: 19 },
  'Durgam Cheruvu': { lat: 17.448, lng: 78.385, line: 'blue', idx: 20 },
  'HITEC City': { lat: 17.4504, lng: 78.3808, line: 'blue', idx: 21 },
  Raidurg: { lat: 17.4429, lng: 78.3773, line: 'blue', idx: 22 },
  // GREEN LINE: JBS → MGBS (9)
  'JBS Parade Ground': { lat: 17.4398, lng: 78.4935, line: 'green', idx: 0 },
  'Secunderabad West': { lat: 17.436, lng: 78.49, line: 'green', idx: 1 },
  'Gandhi Hospital': { lat: 17.431, lng: 78.487, line: 'green', idx: 2 },
  Musheerabad: { lat: 17.422, lng: 78.483, line: 'green', idx: 3 },
  'RTC Cross Roads': { lat: 17.414, lng: 78.481, line: 'green', idx: 4 },
  Chikkadpally: { lat: 17.407, lng: 78.48, line: 'green', idx: 5 },
  Narayanguda: { lat: 17.397, lng: 78.481, line: 'green', idx: 6 },
  'Sultan Bazaar': { lat: 17.387, lng: 78.481, line: 'green', idx: 7 },
  MGBS: { lat: 17.3782, lng: 78.4812, line: 'green', idx: 8 },
};

// ─── MMTS STATION DATABASE ───────────────────────────────────────────────
const MMTS_STATIONS = {
  Lingampally: { lat: 17.4836, lng: 78.3158, line: 'mmts_hl', idx: 0 },
  Chandanagar: { lat: 17.4934, lng: 78.3309, line: 'mmts_hl', idx: 1 },
  Hafeezpet: { lat: 17.4883, lng: 78.3541, line: 'mmts_hl', idx: 2 },
  Borabanda: { lat: 17.4646, lng: 78.397, line: 'mmts_hl', idx: 4 },
  'Bharat Nagar MMTS': { lat: 17.4623, lng: 78.4239, line: 'mmts_hl', idx: 5 },
  Sanathnagar: { lat: 17.4589, lng: 78.4357, line: 'mmts_hl', idx: 6 },
  Fatehnagar: { lat: 17.4552, lng: 78.4452, line: 'mmts_hl', idx: 7 },
  'Nature Cure': { lat: 17.4526, lng: 78.4523, line: 'mmts_hl', idx: 8 },
  'Begumpet MMTS': { lat: 17.4474, lng: 78.4619, line: 'mmts_hl', idx: 9 },
  'Sanjeevaiah Park': { lat: 17.4371, lng: 78.4759, line: 'mmts_hl', idx: 10 },
  'James Street': { lat: 17.4363, lng: 78.4842, line: 'mmts_hl', idx: 11 },
  'Secunderabad MMTS': { lat: 17.4337, lng: 78.5016, line: 'mmts_hl', idx: 12 },
  Sitafalmandi: { lat: 17.4243, lng: 78.5132, line: 'mmts_sf', idx: 13 },
  'Arts College': { lat: 17.4124, lng: 78.5173, line: 'mmts_sf', idx: 14 },
  'Jamai Osmania': { lat: 17.4045, lng: 78.519, line: 'mmts_sf', idx: 15 },
  'Vidya Nagar': { lat: 17.398, lng: 78.5113, line: 'mmts_sf', idx: 16 },
  Kacheguda: { lat: 17.3887, lng: 78.4975, line: 'mmts_sf', idx: 17 },
  'Malakpet MMTS': { lat: 17.3768, lng: 78.4925, line: 'mmts_sf', idx: 18 },
  Dabirpura: { lat: 17.3687, lng: 78.4862, line: 'mmts_sf', idx: 19 },
  Yakutpura: { lat: 17.3615, lng: 78.4849, line: 'mmts_sf', idx: 20 },
  Huppuguda: { lat: 17.3503, lng: 78.4812, line: 'mmts_sf', idx: 21 },
  Falaknuma: { lat: 17.3411, lng: 78.4735, line: 'mmts_sf', idx: 22 },
};

// ─── TSRTC BUS HUB DATABASE ──────────────────────────────────────────────
const BUS_HUBS = {
  'Mehdipatnam Hub': { lat: 17.3916, lng: 78.4398, line: 'bus' },
  'Koti Hub': { lat: 17.3833, lng: 78.4833, line: 'bus' },
  'Gachibowli Hub': { lat: 17.4401, lng: 78.3489, line: 'bus' },
  'Kondapur Hub': { lat: 17.4622, lng: 78.3587, line: 'bus' },
  Afzalgunj: { lat: 17.3797, lng: 78.4776, line: 'bus' },
  'Secunderabad Bus': { lat: 17.4365, lng: 78.5011, line: 'bus' },
  'Uppal X Roads': { lat: 17.3996, lng: 78.5574, line: 'bus' },
  'LB Nagar Hub': { lat: 17.3477, lng: 78.5524, line: 'bus' },
  'KPHB Hub': { lat: 17.4835, lng: 78.3891, line: 'bus' },
  Patancheru: { lat: 17.5287, lng: 78.2661, line: 'bus' },
  Shamshabad: { lat: 17.2568, lng: 78.4357, line: 'bus' },
  'ECIL X Roads': { lat: 17.4725, lng: 78.563, line: 'bus' },
};
...
const EBIKE_STATIONS = [
  ...
  {
    station: 'Miyapur Metro',
    provider: 'Metro E-Bike',
    lat: 17.4964,
    lng: 78.3731,
    icon: 'metro',
  },
  {
    station: 'Secunderabad Stn',
    provider: 'Yulu',
    lat: 17.4337,
    lng: 78.5016,
    icon: 'yulu',
...
const TRANSLATIONS = {
  en: {
    ...
    plan_welcome:
      'Enter any address in Hyderabad to find multi-modal transit routes.',
    ...
    title_ebikes:
      '<i class="fa-solid fa-bicycle" style="margin-right:4px;"></i> Nearby E-Bikes',
    ebike_available: 'available',
    ble_desc:
      'Simulating BLE beacon scans to estimate coach crowding for the next approaching Metro train.',
  ...
  te: {
    ...
    plan_welcome:
      'మల్టీ-మోడల్ రవాణా మార్గాలను కనుగొనడానికి హైదరాబాద్‌లో ఏదైనా చిరునామాను నమోదు చేయండి.',
    ...
    pass_empty:
      'యాక్టిവ് పాస్‌లు లేవు.<br>హైడ్రాపాస్‌ని జనరేట్ చేయడానికి ప్రయాణ మార్గాన్ని బుక్ చేయండి.',
    ...
    title_ebikes:
      '<i class="fa-solid fa-bicycle" style="margin-right:4px;"></i> సమీపంలోని ఇ-బైక్‌లు',
    ebike_available: 'అందుబాటులో',
    ble_desc:
      'తదుపరి మెట్రో రైలు కోచ్ క్రౌడింగ్‌ను అంచనా వేయడానికి బ్లూటూత్ బీకాన్ స్కాన్‌లను అనుకరించడం.',
  ...
  hi: {
    ...
    plan_welcome:
      'मल्टी-मोडल पारगमन मार्ग खोजने के लिए हैदराबाद में कोई भी पता दर्ज करें।',
    ...
    pass_empty:
      'कोई सक्रिय पास नहीं है।<br>हाइड्रापास उत्पन्न करने के लिए एक मार्ग बुक करें।',
    ...
    title_ebikes:
      '<i class="fa-solid fa-bicycle" style="margin-right:4px;"></i> निकटतम ई-बाइक',
    ebike_available: 'उपलब्ध',
    ble_desc:
      'अगली मेट्रो ट्रेन के लिए डिब्बे की भीड़ का अनुमान लगाने के लिए ब्लूटूथ बीकन स्कैन का अनुकरण करना।',
...
const currentTheme = localStorage.getItem('ht_theme') || 'dark';
...
function initMap() {
  ...
  showToast(
    'HydraTransit Ready',
    'Google Maps loaded — search any address in Hyderabad.'
  );
}
...
function switchTab(tabId, triggerBtn = null) {
  ...
  const btn =
    triggerBtn || document.querySelector(`.tab-btn[onclick*="'${tabId}'"]`);
...
function renderStatsTab() {
  ...
  const totalCo2 = Number.parseFloat(wallet.co2 || 0);

  // Quick summary stats
  let totalSpent = 0;
  trips.forEach((t) => {
    const n =
      Number.parseInt((t.fare || '').replace('₹', '').replace(/[^0-9]/g, '')) ||
      0;
    totalSpent += n;
  });
  ...
  trips.forEach((t) => {
    ...
    if (dayData[day] !== undefined)
      dayData[day] += Number.parseFloat(t.co2 || 0);
  });
  ...
  labelsEl.innerHTML = days
    .map((d) => {
      const dayName = new Date(d + 'T00:00:00').toLocaleDateString('en-IN', {
        weekday: 'short',
      });
  ...
  const equivs = [
    ...
    {
      icon: '💡',
      label: 'Bulb Hours Powered',
      val: `${(totalCo2 * 500).toFixed(0)} hrs`,
    },
    {
      icon: '📱',
      label: 'Phone Charges Saved',
      val: `${((totalCo2 * 1000) / 0.012).toFixed(0)}x`,
    },
  ];
  equivEl.innerHTML = equivs
    .map(
      (e) => `
...
function notifyQuotaLimit() {
  ...
  showToast(
    'API Limit Reached',
    'Maps quota is limited. Showing simulated route fallbacks where needed.'
  );
}
...
async function triggerSearch() {
  ...
  if (!d) {
    try {
      ...
      showToast(
        ...
        'Could not locate the destination address.'
      );
      return;
    }
  }
  ...
  try {
    ...
    if (currentRoutes.length > 0) {
      ...
      showToast(
        'Routes Found',
        'Showing Google routes while simulated options load.'
      );
    } else {
      container.innerHTML =
        '<div class="empty-state"><i class="fa-solid fa-route"></i><p>Building simulated transit routes...</p></div>';
    }
    ...
    try {
      ...
      showToast(
        'Simulated Routes Limited',
        'Some backup routes could not be generated.'
      );
    }

    if (currentRoutes.length === 0) {
      container.innerHTML =
        '<div class="empty-state"><i class="fa-solid fa-route"></i><p>No transit routes found between these locations in Hyderabad.</p></div>';
      showToast(
        'No Routes',
        'Google Maps could not find a transit route here.'
      );
      return;
    }
...
function processAndSortRoutes() {
  ...
  if (transitRoutes.length > 0) {
    ...
    transitRoutes.forEach((r, i) => {
      ...
      r.cheapest = false;
      r.bestOverall = false;
      if (r.durationValue < minDur) {
        minDur = r.durationValue;
        fastestIdx = i;
      }

      const co2 = Number.parseFloat(r.co2Saved);
      if (co2 > maxCo2) {
        maxCo2 = co2;
        ecoBestIdx = i;
      }
      ...
      const fValue =
        r.fare === 'Free' ? 0 : Number.parseInt(r.fare.replace(/\D/g, '')) || 0;
      if (fValue < minFare) {
        minFare = fValue;
        cheapestIdx = i;
      }
    ...
    transitRoutes.forEach((r, i) => {
      ...
      if (isEbikeMode) {
        ...
        r.segments.forEach((s) => {
          if (s.type === 'walk' && Number.parseInt(s.duration) > 3) {
            s.type = 'ebike';
            s.icon = 'fa-bicycle';
            s.name = 'Yulu E-Bike';
            s.duration = Math.round(Number.parseInt(s.duration) / 3) + ' min';
            s.color = '#38bdf8';
        ...
        r.fare = `₹${fValue}`;
        r.co2Saved = (Number.parseFloat(r.co2Saved) + 0.5).toFixed(1);
        r.points += 20;
      }

      const score =
        (r.durationValue / 60) * 2 +
        fValue -
        co2 * 10 +
        cabPenalty +
        monsoonPenalty +
...
function parseTransitRoute(route, idx) {
  ...
  leg.steps.forEach((step) => {
    ...
    if (step.travel_mode === 'TRANSIT') {
      ...
      const lineColor =
        lineObj.color || TRANSIT_TYPE_COLORS[vType] || '#38bdf8';
      ...
      if (distKm > 0.05) {
        segments.push({
          type: 'walk',
          name: `Walk ${Math.round(distKm * 1000)}m`,
          dist: distKm,
  ...
  return {
    ...
    title:
      segments
        ...
        .map(
          (s) =>
            `${s.type === 'metro' ? '🚇' : s.type === 'bus' ? '🚌' : '🚆'} ${s.name}`
        )
        .join(' → ') || 'Transit',
...
function parseDrivingRoute(route) {
  ...
  return {
    ...
    polylinePaths: [
      { path: route.overview_path, color: '#f87171', weight: 4, dash: true },
    ],
    co2Saved: '0',
    points: 0,
    baseline: true,
...
function getLiveTransitDetails(type, fromName, toName) {
  ...
  if (type === 'bus') {
    ...
    routeNum =
      'Bus ' + busRoutes[(fromName.length + toName.length) % busRoutes.length];
  } else if (type === 'metro') {
  ...
  return {
    routeNum,
    liveETA: `Live: ${etaMins} min${etaMins > 1 ? 's' : ''} away`,
  };
}
...
function estimateFare(segments) {
  ...
  segments.forEach((s) => {
    if (s.type === 'metro') {
      if (s.dist <= 2) total += 10;
      else if (s.dist <= 6) total += 20;
      else if (s.dist <= 12) total += 30;
      else if (s.dist <= 20) total += 45;
      else total += 60;
    } else if (s.type === 'bus') {
...
function calcCO2Saved(totalDist, segments) {
  ...
  segments.forEach((s) => {
    ...
    else if (s.type === 'metro' || s.type === 'train')
      actualEmissions += s.dist * ECO_MODEL.co2.metro;
  });
...
function calcRoutePointDetails(segments, isMultiModal) {
  let greenDist = 0;
  segments.forEach((s) => {
    if (s.type !== 'cab') greenDist += s.dist;
  });
...
function calcPointDetails(distKm, isMultiModal) {
  ...
  if ((hr >= 7 && hr <= 9) || (hr >= 17 && hr <= 20))
    pts *= ECO_MODEL.earn.peakHour;
...
function renderRouteCards() {
  ...
  if (currentRoutes.length === 0) {
    container.innerHTML =
      '<div class="empty-state"><i class="fa-solid fa-triangle-exclamation"></i><p>No transit routes found. Try different locations.</p></div>';
    return;
  }
  container.innerHTML = currentRoutes
    .map(
      (r, i) => `
        <div class="route-card glass-card ${r.bestOverall ? 'recommended' : ''} ${r.baseline ? 'baseline' : ''}"
            ...
            <div class="route-meta">
                ...
                ${Number.parseFloat(r.co2Saved) > 0 ? `<span class="eco-chip"><i class="fa-solid fa-leaf"></i> -${r.co2Saved}kg CO₂ <span class="pts-chip">+${r.points}pts</span></span>` : '<span class="no-eco"><i class="fa-solid fa-car"></i> No credits</span>'}
            </div>
      ...
      .map((s, i) => {
        ...
        if (
          ...
          const liveBadge = isLive
            ? `<span class="live-dot pulse" style="display:inline-block;width:8px;height:8px;background:#10b981;border-radius:50%;margin-right:4px;animation:pulse 1.5s infinite;"></span>`
            : '';
...
function selectRoute(idx) {
  ...
  if (splitBtn) {
    ...
    splitBtn.style.opacity =
      route.baseline || passengerCount === 1 ? '0.3' : '1';
    splitBtn.style.cursor =
      route.baseline || passengerCount === 1 ? 'not-allowed' : 'pointer';
  }
      ...
      opts.icons = [
        {
          icon: {
            path: 'M 0,-1 0,1',
            strokeOpacity: pp.isFallback ? 0.45 : 0.7,
            strokeColor: pp.color,
            scale: pp.isFallback ? 2 : 3,
          },
          offset: '0',
          repeat: pp.isFallback ? '18px' : '12px',
        },
      ];
    }
...
function updatePassForRoute(route) {
  ...
  if (route.baseline) {
    inv.innerHTML =
      '<div class="invoice-row"><span>Private rides are not eligible for HydraPass</span></div>';
    return;
  }
...
function renderPassTypes() {
  ...
  c.innerHTML = PASS_TYPES.map((p) => {
    const loc = PASS_TYPES_LOCALIZED[currentLanguage][p.id] || {
      name: p.name,
      desc: p.desc,
    };
    return `
...
function purchasePass() {
  ...
  if (msSinceLast < ECO_MODEL.cooldownMin * 60000 && wallet.lastTrip > 0) {
    const wait = Math.ceil(
      (ECO_MODEL.cooldownMin * 60000 - msSinceLast) / 60000
    );
  ...
  wallet.points += pts;
  wallet.co2 += Number.parseFloat(route.co2Saved) * passengerCount;
  wallet.ptsToday += pts;
  wallet.lastTrip = now;

  let totalFareStr = route.fare;
  if (passengerCount > 1) {
    const fareNum = Number.parseInt(route.fare.replace('₹', ''));
  ...
  wallet.trips.unshift({
    ...
    route: route.title,
    fare: totalFareStr,
    co2: (Number.parseFloat(route.co2Saved) * passengerCount).toFixed(1),
    pts,
...
function generateTicket(passId, route, pts, pax = 1, fareStr = route.fare) {
  ...
  ticketArea.innerHTML = `
        <div class="hydra-ticket revealing" style="--mode-gradient:${modeGradient}">
            ...
            ${
              segs.length > 0
                ? `<div class="ticket-line-info" style="color:${mainSeg.color || '#fff'}">
...
function renderMockBLE(statusText = 'Connected (Simulated)') {
  ...
  document.getElementById('coach-list').innerHTML = coaches
    .map((c, i) => coachRow(c, seededBlePercent(i, 12, 78)))
    .join('');
}
...
async function scanBLE() {
  ...
  if (!window.isSecureContext || !navigator.bluetooth) {
    ...
    const iv = setInterval(() => {
      ...
      if (n <= 0) {
        ...
        showToast(
          'BLE Radar Active',
          'Using simulated coach data (Web Bluetooth is unavailable in this browser/context).'
        );
      } else {
  ...
  try {
    ...
    showToast(
      'BLE Radar Active',
      'Successfully connected to physical coach beacon.'
    );

    const coaches = ['C1 Front (Women)', 'C2', 'C3', 'C4 Mid', 'C5', 'C6 Rear'];
    document.getElementById('coach-list').innerHTML = coaches
      .map((c, i) => coachRow(c, seededBlePercent(i, 10, 50)))
      .join('');
  } catch (e) {
    let n = 3;
    const iv = setInterval(() => {
      ...
      if (n <= 0) {
        ...
        showToast(
          'BLE Radar Active',
          'Using simulated coach data (Web Bluetooth not supported or permission denied).'
        );
      } else {
        t.textContent = `Scanning... ${n}s`;
      }
...
function walletPayloadFromStorage() {
  return {
    points: Number.parseInt(localStorage.getItem('ht_pts')) || 0,
    co2: Number.parseFloat(localStorage.getItem('ht_co2')) || 0,
    ptsToday: Number.parseInt(localStorage.getItem('ht_ptsd')) || 0,
    lastTrip: Number.parseInt(localStorage.getItem('ht_lt')) || 0,
    streak: Number.parseInt(localStorage.getItem('ht_str')) || 0,
...
function walletSignature(payload) {
  ...
  for (let i = 0; i < data.length; i++)
    sum = (sum + data.charCodeAt(i) * (i + 17)) % 1000003;
...
function loadWallet() {
  ...
  if (
    hasExistingWallet &&
    storedSig &&
    storedSig !== walletSignature(payload)
  ) {
...
function resetDailyCaps() {
  ...
  if (last !== today) {
    if (last) {
      ...
      wallet.streak = d <= 1 ? wallet.streak + 1 : 0;
...
function getStationsOnLine(line, startIdx, endIdx) {
  ...
  if (line.startsWith('mmts')) {
    ...
    all = Object.entries(METRO_STATIONS)
      .filter(([n, s]) => s.line === line)
      .map(([n, s]) => ({ name: n, ...s }));
  }
  all.sort((a, b) => a.idx - b.idx);
  const min = Math.min(startIdx, endIdx);
  const max = Math.max(startIdx, endIdx);
  const path = all.filter((s) => s.idx >= min && s.idx <= max);
...
function getMetroInterchangePair(fromLine, toLine) {
  ...
  return fromLineStation && toLineStation
    ? { fromLineStation, toLineStation }
    : null;
}

function buildStationTransitLeg(fromStation, toStation) {
  if (!fromStation || !toStation || fromStation.line !== toStation.line)
    return null;
  const stns = getStationsOnLine(
    fromStation.line,
    fromStation.idx,
    toStation.idx
  );
  ...
  return {
    ...
    polyline: {
      path: stns.map((s) => ({ lat: s.lat, lng: s.lng })),
      color,
      weight: 6,
    },
  };
...
async function buildSyntheticRoute(o, d, s1, s2, modeClass) {
  ...
  if (leg1.dist > 0.05) {
    ...
    if (startMode === 'DRIVING') {
      if (leg1.dist > 3) {
        legType = 'bus';
        legName = `Feeder Bus to ${s1.name}`;
        leg1.duration = Math.ceil(leg1.dist * 4) + 5;
        startDurStr = `${leg1.duration} mins (Feeder)`;
      } else {
        leg1.duration += 10;
        startDurStr += ' (+10m Uber Wait)';
      }
    }
    segments.push({
      type: legType,
  ...
  if (
    s1.mode === s2.mode &&
    (s1.mode === 'metro' || s1.mode === 'train') &&
    s1.line === s2.line
  ) {
    const stns = getStationsOnLine(s1.line, s1.idx, s2.idx);
    const legPath = stns.map((s) => ({ lat: s.lat, lng: s.lng }));
    for (let i = 1; i < stns.length; i++)
      transitDist += getDistance(
        stns[i - 1].lat,
        stns[i - 1].lng,
        stns[i].lat,
        stns[i].lng
    ...
    const color =
      pMode === 'metro'
        ? LINE_COLORS[s2.line] || LINE_COLORS[s1.line] || '#f43f5e'
        : pMode === 'train'
          ? '#00897B'
          : '#7B1FA2';
    transitMins = Math.ceil(
      transitDist * (pMode === 'train' ? 1.5 : pMode === 'metro' ? 2 : 3)
    );
    ...
    segments.push({
      ...
      from: s1.name,
      to: s2.name,
      stops: Math.ceil(transitDist / 1.5),
      depTime: live.liveETA,
      arrTime: '+' + transitMins + ' min',
      dist: transitDist,
      color: color,
  ...
  if (leg2.dist > 0.05) {
    ...
    if (endMode === 'DRIVING') {
      if (leg2.dist > 3) {
        legType = 'bus';
        legName = `Feeder Bus from ${s2.name}`;
        leg2.duration = Math.ceil(leg2.dist * 4) + 5;
        endDurStr = `${leg2.duration} mins (Feeder)`;
      } else {
        leg2.duration += 10;
        endDurStr += ' (+10m Uber Wait)';
      }
    }
    segments.push({
      type: legType,
  ...
  return {
    ...
    rawPoints: pointDetails.raw,
    pointCapReached: pointDetails.capReached,
    recommended: modeClass === 'multi',
    fastest: false,
    depTime: new Date().toLocaleTimeString([], {
      hour: '2-digit',
      minute: '2-digit',
    }),
    arrTime: new Date(Date.now() + totalMins * 60000).toLocaleTimeString([], {
      hour: '2-digit',
      minute: '2-digit',
    }),
    rawRoute: null,
...
async function buildTrueMultiModal(o, d, ixRank = 0) {
  ...
  const dBest = dAll.find((st) => st.mode !== oBest.mode);
  if (!dBest) return null;

  const INTERCHANGES = [
    { name: 'Ameerpet Interchange', lat: 17.4375, lng: 78.4482 },
    { name: 'Secunderabad Hub', lat: 17.433, lng: 78.5016 },
  ...
  const midLat = (oLat + dLat) / 2,
    midLng = (oLng + dLng) / 2;
  const sortedIx = INTERCHANGES.sort(
    (a, b) =>
      getDistance(midLat, midLng, a.lat, a.lng) -
      getDistance(midLat, midLng, b.lat, b.lng)
  );
  ...
  const leg1 = await getRoadLeg(
    o,
    { lat: oBest.lat, lng: oBest.lng },
    startMode
  );
  const t1 = await getRoadLeg(
    { lat: oBest.lat, lng: oBest.lng },
    { lat: ix.lat, lng: ix.lng },
    'DRIVING'
  );
  const t2 = await getRoadLeg(
    { lat: ix.lat, lng: ix.lng },
    { lat: dBest.lat, lng: dBest.lng },
    'DRIVING'
  );
  ...
  if (leg1.dist > 0.05) {
    ...
    if (startMode === 'DRIVING') {
      if (leg1.dist > 3) {
        legType = 'bus';
        legName = `Feeder Bus to ${oBest.name}`;
        leg1.duration = Math.ceil(leg1.dist * 4) + 5;
        startDurStr = `${leg1.duration} mins (Feeder)`;
      } else {
        leg1.duration += 10;
  ...
  const color1 =
    oBest.mode === 'metro'
      ? oBest.line
        ? LINE_COLORS[oBest.line]
        : '#f43f5e'
      : oBest.mode === 'train'
        ? '#00897B'
        : '#7B1FA2';
  const min1 = Math.ceil(
    t1.dist * (oBest.mode === 'train' ? 1.5 : oBest.mode === 'metro' ? 2 : 3)
  );
  ...
  segments.push({
    ...
    from: oBest.name,
    to: ix.name,
    stops: Math.ceil(t1.dist / 1.5),
    depTime: live1.liveETA,
    arrTime: '+' + min1 + ' min',
    dist: t1.dist,
    color: color1,
  });
  ...
  const color2 =
    dBest.mode === 'metro'
      ? dBest.line
        ? LINE_COLORS[dBest.line]
        : '#f43f5e'
      : dBest.mode === 'train'
        ? '#00897B'
        : '#7B1FA2';
  const min2 = Math.ceil(
    t2.dist * (dBest.mode === 'train' ? 1.5 : dBest.mode === 'metro' ? 2 : 3)
  );
  segments.push({
    type: dBest.mode,
    name:
    ...
    from: ix.name,
    to: dBest.name,
    stops: Math.ceil(t2.dist / 1.5),
    depTime: '+' + min1 + ' min',
    arrTime: '+' + (min1 + min2) + ' min',
    dist: t2.dist,
    color: color2,
  });
  polylinePaths.push({
  ...
  if (leg2.dist > 0.05) {
    ...
    if (endMode === 'DRIVING') {
      if (leg2.dist > 3) {
        legType = 'bus';
        legName = `Feeder Bus from ${dBest.name}`;
        leg2.duration = Math.ceil(leg2.dist * 4) + 5;
        endDurStr = `${leg2.duration} mins (Feeder)`;
      } else {
        leg2.duration += 10;
...
function toggleMonsoonMode() {
  ...
  if (isMonsoonMode) {
    ...
    showToast(
      'Monsoon Active',
      'Simulating heavy rain. Expect surge pricing for autos.'
    );
  } else {
...
function toggleVoiceMode() {
  ...
  if (isVoiceMode) {
    showToast(
      'Voice Guide Active',
      'Navigation will play in your selected language.'
    );
...
function toggleEbikeMode() {
  ...
  if (isEbikeMode) {
    showToast(
      'E-Bike Mode Active',
      'Long walks are now replaced with Yulu rides.'
    );
  } else {
...
function triggerSOS() {
  ...
  toast.innerHTML =
    '<i class="fa-solid fa-triangle-exclamation"></i><div><h5 style="color:white;margin:0;">Emergency SOS Triggered</h5><p style="color:white;margin:0;">Live location shared with Police & Emergency Contacts.</p></div>';
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      toast.innerHTML =
        '<i class="fa-solid fa-circle-check"></i><div><h5 id="toast-title"></h5><p id="toast-desc"></p></div>';
    }, 300);
  }, 4000);
}
...
function toggleTheme() {
  ...
  if (body.classList.contains('light-mode')) {
    ...
    showToast(
      'Light Mode Active',
      'Switched to clean light high-contrast map style.'
    );
  }
}
...
function toggleSidebar() {
  ...
  if (sidebar.classList.contains('collapsed')) {
    ...
    showToast(
      'Sidebar Collapsed',
      'Maps view maximized. Click floating arrow to expand.'
    );
  }
...
function renderEbikes() {
  ...
  const availLabel =
    (TRANSLATIONS[currentLanguage] &&
      TRANSLATIONS[currentLanguage].ebike_available) ||
    'available';
  const baseLat = originPlace?.geometry?.location
    ? typeof originPlace.geometry.location.lat === 'function'
      ? originPlace.geometry.location.lat()
      : originPlace.geometry.location.lat
    : 17.41;
  const baseLng = originPlace?.geometry?.location
    ? typeof originPlace.geometry.location.lng === 'function'
  ...
  container.innerHTML = EBIKE_STATIONS.map((station) => {
    ...
    const distM = Math.round(
      getDistance(baseLat, baseLng, station.lat, station.lng) * 1000
    );
    const distanceLabel =
      distM >= 1000 ? `${(distM / 1000).toFixed(1)}km away` : `${distM}m away`;
